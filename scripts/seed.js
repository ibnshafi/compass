  ...
  const resources = [
    {
      ...
      description:
        "Provides emergency food assistance to families and individuals in need. Distribution every Tuesday and Thursday.",
    ...
    },
    {
      ...
      description:
        "Connects families with affordable in-home care services for seniors. Offers free consultations and care assessments.",
      type: "HOME_CARE",
      city: "Portland",
      state: "OR",
      phone: "(503) 555-0102",
    ...
    },
    {
      ...
      description:
        "Helps individuals and families sign up for affordable health insurance, Medicare, and Medicaid. Bilingual staff available.",
      type: "HEALTHCARE",
      city: "Portland",
      state: "OR",
      phone: "(503) 555-0103",
    ...
    },
    {
      ...
      description:
        "Provides free or low-cost transportation to medical appointments for seniors and people with disabilities.",
      type: "TRANSPORTATION",
      city: "Portland",
      state: "OR",
      phone: "(503) 555-0104",
    ...
    },
    {
      ...
      description:
        "Helps patients access affordable medications through manufacturer assistance programs and discount cards.",
      type: "PRESCRIPTION_ASSISTANCE",
      city: "Portland",
      state: "OR",
      phone: "(503) 555-0105",
    ...
    },
    {
      ...
      description:
        "Weekly support group for family caregivers. Offers emotional support, resources, and practical advice from other caregivers.",
      type: "SUPPORT_GROUP",
      city: "Portland",
      state: "OR",
      phone: "(503) 555-0106",
    ...
    },
    {
      ...
      description:
        "Provides rental assistance, housing counseling, and help with utility bills for low-income families and seniors.",
      type: "HOUSING",
      city: "Portland",
      state: "OR",
      phone: "(503) 555-0107",
    ...
    },
    {
      ...
      description:
        "Helps seniors access Supplemental Security Income (SSI), Social Security benefits, and other financial assistance programs.",
    ...
    },
    {
      ...
      description:
        "24/7 mental health crisis support and counseling for seniors and caregivers. Immediate phone support available.",
      type: "MENTAL_HEALTH",
      city: "Portland",
      state: "OR",
      phone: "(503) 555-0109",
    ...
    },
    {
      ...
      description:
        "Delivers nutritious meals to homebound seniors. Special dietary needs accommodated including diabetic, low-sodium, and pureed options.",
      type: "FOOD_ASSISTANCE",
      city: "Portland",
      state: "OR",
      phone: "(503) 555-0110",
